...
def ffwd(data_in, paths_out, checkpoint_dir, device_t='/gpu:0', batch_size=4):
    ...
    print('type(data_in[0])', type(str(data_in[0])))
...
def generate_to_art(param, device='/cpu:0'):
    input_img_path = str(param['input_img_path'].decode('utf-8'))
    output_img_path = str(param['output_img_path'].decode('utf-8'))
    model_path = str(param['model_path'].decode('utf-8'))
    print(input_img_path)
    print(output_img_path)
    print(model_path)
    print("========")
    ffwd([input_img_path], [output_img_path], model_path, batch_size=1, device_t=device)
