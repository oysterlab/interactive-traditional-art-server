...
switch (hash) {
  case PHOTO_VIEW:
    var photoView = new _photo2.default();
    photoView.appendTo(app);
    break;

  case HISTORY_VIEW:
    var historyView = new _history2.default();
    historyView.appendTo(app);
    break;

  case ART_VIEW:
    var artView = new _art2.default();
    artView.appendTo(app);
    break;

  default:
    var testView = new _test2.default();
    testView.appendTo(app);
}

},{"./art":8,"./history":9,"./photo":11,"./test":12}],11:[function(require,module,exports){
'use strict';
...
var TestView = function () {
  ...
  _createClass(TestView, [{
    ...
    value: function appendTo(ele) {
      ele.appendChild(this.rootView);
      console.log('test');
      request.get('http://localhost:5000/send_image').end(function (err, res) {
        console.log(err, res);
      });
    }
  }]);
